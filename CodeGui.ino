...
int mappedValue = map(cbd, 0, 1024, 0, 100); // Ánh xạ giá trị từ 0-1023 thành 0-100
int phantram = 100 - mappedValue; // Chuyển đổi thành giá trị phần trăm 
int thr3 = device.read("nguongdat").asInt();
...
if (millis() - TimeMark >= 1000) {  
  TimeMark = millis(); 
  device.write("cambiendoamdat", phantram);
